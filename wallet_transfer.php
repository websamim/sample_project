                                    ...
                                    <div class="p-all-15">
                                        <div class="row">
                                            <div class="col-md-12 my-2 m-md-0">
                                                <div class="text-overline opacity-75">Total Transfer</div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row m-b-20">
                                            <div class="col-md-6 my-auto">
                                                <a href="javascript:void(0);" class="btn btn-lg m-b-15 mr-2 btn-outline-dark" data-toggle="modal" data-target="#newPayment"> <i class="mdi mdi-plus"></i> Wallet Transfer</a>
                                            </div>
                                            ...
                                            <div class="col-md-12 p-0">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $user->query("SELECT users.email AS from_email, transfer_wallet.to_email AS to_email, transfer_wallet.reason AS reason, transfer_wallet.amount AS amount, transfer_wallet.status AS status, transfer_wallet.dtime AS dtime FROM transfer_wallet INNER JOIN (SELECT id, email FROM users) users ON users.id = transfer_wallet.from_id WHERE transfer_wallet.from_id = :session_id ORDER BY transfer_wallet.id DESC");
                                                                ...
                                                                foreach($user->fetchAll() as $row) {
                                                                    ...
                                                                    echo '<tr>
                                                                        ...
                                                                        <td class="align-middle">'.$row['from_email'].'</td>
                                                                        <td class="align-middle">'.$row['to_email'].'</td>
        ...
        <div class="modal fade" id="newPayment" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog  modal-dialog-align-top-left" role="document">
                <div class="modal-content">
                    <form method="post" action="action/user.action.php" id="walletForm">
                    ...
                    <div class="modal-body">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="email" name="email" class="form-control" placeholder="Enter email" id="userEmail" autofocus="autofocus" required>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="full_name" class="form-control" id="fullName" readonly required>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="amount" class="form-control" placeholder="Enter amount" id="userAmount" required>
                                </div>
                            </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="walletTransfer" class="btn btn-primary">Save changes</button>
                    </div>
                    </form>
                </div>
            </div>
        ...
        <script>
            $(document).ready(function(){
                $("#userEmail").on("focusout", function(e){
                    ...
                    if(email != ''){
                        var data = "getUsername&email=" + email;
                        $.ajax({
                            type : "POST",
                            ...
                            success : function(data, status){
                                ...
                                if(res.status == "success"){
                                    var user_data = res.msg;
                                    $("#fullName").val(user_data.fname + " " + user_data.lname);
                                    $("#error").html('');
                                }else{
                                    $("#error").html(`<p style="color:red";>${res.msg}</p>`);
                                    $("#fullName").val('');
                                }
                            }
                        });
                    }else{
                        $("#error").html('<p style="color:red";>Please enter E-mail</p>');
                    }
            });
        });
        </script>
