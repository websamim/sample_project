                                    ...
                                    <div class="p-all-15">
                                        <div class="row">
                                            <div class="col-md-12 my-2 m-md-0">
                                                <div class="text-overline opacity-75">Total Deposit</div>
                                    ...
                                    <div class="card-body">
                                    	<div class="row m-b-20">
                                            <div class="col-md-6 my-auto">
                                               <a href="new_deposite.php" class="btn btn-lg m-b-15 mr-2 btn-outline-dark" data-toggle="modal" data-target="#newPayment"> <i class="mdi mdi-plus"></i> Make a Deposite</a>
                                            </div>
                                            ...
                                            <div class="col-md-12 p-0">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $user->query("SELECT amount, receipt, reason, status, dtime FROM deposit WHERE user_id = :session_id ORDER BY id DESC");
                                                                $user->bind("session_id", $user->sessionID());
                                                                $i = 1;
                                                                foreach($user->fetchAll() as $row){
                                                                    ...
                                                                    echo '<tr>
                                                                        ...
                                                                        <td class="align-middle" style="color:blue;"><a href="img/receipt/'.$row['receipt'].'" target="_blank">View/Download</a></td>
...
<!--                         	<div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="form-control">
                                    	<option value="manula">Manual Payment</option>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="depositAmount" class="btn btn-primary">Deposit</button>
                    </div>
                    </form>
                </div>
            </div>
